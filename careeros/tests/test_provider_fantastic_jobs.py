"""Tests for careeros/providers/fantastic_jobs.py's pure functions:
run-input construction (source-side filtering) and token-pool parsing (the
rotation mechanism). No network calls — ApifyClient itself is never touched
here, only the config -> run_input mapping and env-var parsing."""

from __future__ import annotations

from careeros.providers.fantastic_jobs import (
    _build_run_input, _contact_from_ai_fields, _iter_tokens, _merge_query,
    _remote_from_arrangement, _salary_from_ai_fields,
)
