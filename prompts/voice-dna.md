...
Imported by the active resume prompt, cover_v1.md, deep_report_v1.md, and
apply_v1.md —
...
own prompt, don't fork this file.
-->
...
- When uncertain, say so plainly ("I think," "probably," "maybe," "kinda"). AI never hedges. Humans do.
...
**Negative parallelisms and reframe constructions.** This is the single most reliable tell of AI-generated text. Every LLM does it, in every output, multiple times per response.
...
**The fix is simple:** delete everything before the positive claim. If you wrote "It's not about the prompt. It's about the context," just write "It's about the context."
...
### 4C. False ranges
"From ancient traditions to modern innovations." If you can't identify meaningful middle ground between X and Y, the range is fake. Delete it.
...
Delete the participle phrase ("highlighting its importance," "underscoring its significance"). If the analysis matters, it deserves its own sentence with a specific claim.

### 4G. Knowledge-cutoff disclaimers
Never include these.

### 4H. Collaborative communication leakage
"I hope this helps!" "Would you like me to..." belong in chat. Strip them from any published writing.
...
Humans typically use sentence case. Do that.
